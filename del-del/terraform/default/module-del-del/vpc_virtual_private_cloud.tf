...
resource "aws_subnet" "subnet_1d094113" {
  availability_zone                   = var.aws_subnet_subnet_1d094113_availability_zone
...
resource "aws_subnet" "subnet_1dbd203c" {
  availability_zone_id                = var.aws_subnet_subnet_1dbd203c_availability_zone_id
...
resource "aws_subnet" "subnet_a1c457fe" {
  availability_zone_id                = var.aws_subnet_subnet_a1c457fe_availability_zone_id
